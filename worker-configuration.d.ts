/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 5224fbaadf3d5cc85ab93c59aae88403)
// Runtime types generated with workerd@1.20260903.1 2026-07-13 nodejs_compat
interface __BaseEnv_Env {
	TRAINING_DB: D1Database;
	ASSETS: Fetcher;
	TRAINING_OWNER_EMAIL: string;
	TRAINING_DEV_USER: string;
	TRAINING_ACCESS_TEAM: string;
	TRAINING_ACCESS_AUD: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRAINING_OWNER_EMAIL" | "TRAINING_DEV_USER" | "TRAINING_ACCESS_TEAM" | "TRAINING_ACCESS_AUD">> {}
}
